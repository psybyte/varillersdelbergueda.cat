...
const t = {
  ca: {
    ...
    hero_tagline:  'Reparació de pedregades i bonys sense massilla ni pintura',
    ...
    qui_title:     'Qui som',
    qui_p1:        "Som en Jordi i en Pep Mollar, dos professionals especialitzats en la tècnica PDR al Berguedà. Portem anys reparant carrosseries —pintades o no— sense necessitat de massilla ni pintura, i ens apassiona el nostre ofici.",
  ...
  es: {
    ...
    hero_tagline:  'Reparación de granizos y abolladuras sin masilla ni pintura',
    ...
    qui_p1:        'Somos Jordi y Pep Mollar, dos profesionales especializados en la técnica PDR en el Berguedà. Llevamos años reparando carrocerías —pintadas o no— sin necesidad de masilla ni pintura, y nos apasiona nuestro oficio.',
